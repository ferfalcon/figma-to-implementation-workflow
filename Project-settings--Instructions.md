...
Follow the pinned `workflow/ChatGPT-Experience.md` for progressive capability checks, the saved review style, setup, asset handling, previews, and recovery. Follow `workflow/Agent-Orchestration.md` for executable behavior. These resources own detailed workflow mechanics; do not redefine them in these Project instructions.
