...
assert(!workflow.includes('/immutable-releases'), 'Release workflow must not require a repository-administrator token just to inspect immutable-release settings.');
