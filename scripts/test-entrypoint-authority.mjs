...
const requiredQuickstartContracts = [
  ...
  [/GitHub for the implementation repository/i, 'connect GitHub as the repository source'],
  [/Figma for design inspection and authorized design changes/i, 'connect Figma as the design source'],
