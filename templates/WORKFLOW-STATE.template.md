...
Use this file as the operational control record for the current project. Update it whenever stage, readiness, profile, execution mode, blockers, or next permitted action changes.
...
|---:|---|---|---|---|
| 0 | Establish context and control | `PROJECT-CONTEXT.md`, `WORKFLOW-STATE.md` | ... | ... |
| 1 | Audit design evidence | `DESIGN-AUDIT.md` | ... | ... |
...
| Artifact | Status | Version, commit, or date | Approved by or evidence |
|---|---|---|---|
