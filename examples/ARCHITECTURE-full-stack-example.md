...
- rendering accessible disclosure interactions;
- presenting loading, empty, and failure states.

Must not:

- create, update, or delete FAQ records;
- access the database directly;
- contain administrative authorization rules.
...
- creating, editing, publishing, ordering, and deleting FAQs;
- managing categories;
- presenting validation and API errors;
- protecting administrative routes in the interface.
...
- composing infrastructure implementations.
...
- returning transport-independent results.

### Persistence Layer

Responsible for:

- implementing repository contracts with Prisma;
...
The example frontends are organized by feature.
...
- response status;
- execution duration;
- authenticated administrator ID when appropriate;
